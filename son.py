...
def grup1(urls):
	...
	while True:
		try:
			ua = 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/87.0.4280.101 Safari/537.36'
			miskinlu = {"user-agent": ua}
			try:
				url = use[0]
			except:
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				headapp={"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, seperti Gecko) Chrome/87.0.4280.101 Safari/537.36'
				if 'no' in taplikasi:
					ok+=1
